...
class OwnConfirmationForm(forms.ModelForm):
    ...
    priorities = forms.CharField(widget=full_width_text_field, required=False,
            label='Prioriteret rækkefølge af de tre studieretninger, du ønsker at være holdtutor for: mat, møk, fys, nano, dat, dav')
    ...
    class Meta:
        fields = ('study', 'tutortype', 'experience', 'priorities', 'firstaid', 'resits', 'rusfriends'
