...
urlpatterns = static_pages + [
    ...
    path('holdlister/', login_required(RusClassView.as_view()), name='rus_holdlister'),
    path('holdlister/<handle>/', login_required(RusClassDetailView.as_view()), name='rus_holdlister'),
    path('holdlister/<handle>.tex', login_required(RusClassDetailsPrintView.as_view()), name='rus_holdlister_print'),
